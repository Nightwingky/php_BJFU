...
<script type="text/javascript">
	...
	function changeVerificode()
	{
		document.getElementById('capatcha_img').src = 'verificationCode.php?r='+Math.random();
	}
...
<form 
	...
	<p>VerificationCode:
		...
		<a href = "javascript:void(0)" onclick = "changeVerificode()">Another One?</a>
	</p>
	<p>Input:
